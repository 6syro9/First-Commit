      ...
      <div className="container">
        ...
        <div>
           <div className="flex flex-col gap-6 items-center mt-10  lg:flex-row lg:items-end lg:justify-center lg:gap-10">
            ...
            <div className={twMerge("card", inverse ? 'border-black bg-black text-white' : '')}>
              ...
              <button className={twMerge("bg-black px-6 py-3 rounded-lg font-semibold text-white hover:bg-black/90 transition-colors  mt-[30px]",  inverse ? ' bg-white text-black' : '')}>{buttonText}</button>
